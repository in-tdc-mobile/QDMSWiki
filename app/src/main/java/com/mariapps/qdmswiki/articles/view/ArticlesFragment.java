...
public class ArticlesFragment extends BaseFragment {
    ...
    private void setData() {
        ...
        documentsList.add(new DocumentsModel(0,"General Data Protection Manual General Data Protection Manual General Data Protection Manual General Data Protection Manual","GDPR Manual","25/02/2019","11:08:35 AM",department1List));
        ...
        documentsList.add(new DocumentsModel(2,"SMC DE HR Manual","GDPR Manual General Data Protection Manual General Data Protection Manual General Data Protection Manual","25/02/2019","11:08:35 AM",department1List));
        documentsList.add(new DocumentsModel(3,"Incident investigation Manual General Data Protection Manual General Data Protection Manual General Data Protection Manual","GDPR Manual","25/02/2019","11:08:35 AM",department1List));
        documentsList.add(new DocumentsModel(4,"Safety management Manual","GDPR Manual General Data Protection Manual General Data Protection Manual General Data Protection Manual General Data Protection Manual","25/02/2019","11:08:35 AM",department1List));
